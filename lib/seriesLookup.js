...
// real per-card TCGdex detail fetch (the only endpoint that actually
// reports variants — see lib/tcgdexSetLookup.js). Matches card_set
// case-insensitively since that's a free-typed field, same tolerance
// seriesQueryValueFor's callers already assume elsewhere.
export function variantCardNumbersFor(items, cardSetValue) {
