...
export const WHATS_NEW = [
  {
    ...
    body: 'A new option in the dashboard\'s "+ Add Item" menu lets you just type something like "logged a Chrono Trigger for $40 today" — it picks out the title, price, and date as you type, shows you what it understood, and hands it to the normal Add form so you can double-check before saving.',
    detail: 'It\'s a best-effort parser, not a real language model — it looks for a leading verb ("got"/"bought"/"logged"/etc.), a trailing "today"/"yesterday", and a "$N" price, then treats what\'s left as the title. Nothing saves automatically: "Continue" opens the same Add form you\'d normally fill out, pre-filled, so a wrong guess is just something to fix before you hit Save.',
  },
  {
    date: '2026-08-28',
