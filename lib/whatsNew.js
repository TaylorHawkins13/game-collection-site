...
export const WHATS_NEW = [
  {
    date: '2026-08-26',
    title: 'Quick add (search) now lets you set ownership, condition, and price',
    body: 'Each item in your batch gets its own small Ownership/Condition/Price controls before you commit — search still fills in the rest.',
    detail: 'Defaults to "Owned," no condition, no price, same as before — nothing changes unless you touch them. Everything else (purchase date, rating, tags) is still set afterward by editing the item.',
  },
  {
    date: '2026-08-26',
