...
// The "Series" feature's crowdsourced-fallback backend. Funko Pops go
// straight here; comics go to Comic Vine and trading cards try TCGdex
// first (see lib/useSeriesLookup.js) but both fall back to this for
// anything their real backend doesn't recognize — trading cards in
// particular, since TCGdex is Pokémon-only and a non-Pokémon card (Magic,
// mainly) always misses there. Works off Shelf Life's own data instead of
// a real canonical database — every
