// Pure logic for the Pull List (ROADMAP.md's "Pull list / upcoming-
// release calendar with spend forecasting") — kept DB/API-agnostic and
// unit-testable, same split as lib/itemReviews.js/lib/mosaicData.js.
//
...
// price" guesses (see PullListClient.jsx; there's no MSRP/price data
// available from either IGDB or Comic Vine for something that hasn't
// released yet, confirmed while researching this feature, so a real
// number here is unavoidably a guess someone types in, not something
// this app can look up).
...
// PullListClient.jsx — there's no real price data to sum otherwise).
