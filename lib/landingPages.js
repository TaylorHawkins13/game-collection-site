  ...
  'video-game-collection-tracker': {
    ...
    features: [
      ...
      },
      {
        ...
        body: "Type a title and Search pulls cover art, genre, and platforms straight from IGDB — quicker and more reliable than a barcode scan, and it works for digital-only titles and loose carts with no box to scan in the first place.",
      },
      {
