...
function ResetPasswordForm() {
  ...
  async function handleSubmit(e) {
    ...
    // Best-effort, and deliberately not awaited/blocking — the common
    // reason someone resets a password is "I think someone else has it,"
    // so close out any session that was already signed in elsewhere at
