...
- **Leaderboard** (`/leaderboard`): most-owned items, biggest public collections, trending titles (last 14 days), and a trophy case ranking — all with cover art/avatars and gold/silver/bronze styling on the top 3, computed from public collections only. Needs `trophy-leaderboard-migration.sql` on existing projects.
